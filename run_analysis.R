#' Gettin and clenning data - Course Project.
#' 
#' The next code prepare tidy data that can be used for later analysis from 
#' all measures saved from sensors that register lots of info about a man
#' activity that wears the sensors.
#' 
...
#misCols <- c("Subject_id", "Activity_id", "Origin", "Activity_Desc")
...
#' Transform the data fram "tdata" to create the structure necesary to calculate de mean of
#' each group of (subject, activity and variable "measure")
