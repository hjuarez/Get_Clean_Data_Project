...
- Join the train and test info
- Asign the correct name variables
- Include the Subject_id, Activity_id and Activity_Desc
- Filter the variables just leaving all mean and standard desviation variables
- Groups the info by al variables just mentioned
- Calc the mean by group for all variables
- Create the tidyData.txt file ready to use it for other analysis.
